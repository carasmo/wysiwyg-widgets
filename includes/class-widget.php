...
class WYSIWYG_Widgets_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$preserve_formatting = (isset($instance['preserve_formatting'])) ? $instance['preserve_formatting'] : 1;
		$post = get_post( $id );
		...
		if( ! empty( $id ) && $post ) {
			...
			//if preserve formatting is checked the content outputs the exact html in the post editor 
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['preserve_formatting'] = ( isset($new_instance['preserve_formatting'] ) && $new_instance['preserve_formatting'] == 1 ) ? 1 : 0;
		return $instance;
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label><input type="checkbox" id="<?php echo $this->get_field_id( 'preserve_formatting' ); ?>" name="<?php echo $this->get_field_name( 'preserve_formatting' ); ?>" value="1" <?php checked( $preserve_formatting, 1 ); ?> /> <?php _e( "Preserve Formatting?", "wysiwyg-widgets" ); ?></label>
		</p>
